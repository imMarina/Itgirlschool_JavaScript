...
console.log('Добро ' + 'пожаловать, ' + 'Marina');
...
console.log('Влад' + 'и' + 'восток ' + '2000');
...
let salaryOfCleaning = 40000;
let salaryOfTeaching = 22000;

console.log(salaryOfCleaning + salaryOfTeaching);
